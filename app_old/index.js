...
Routes.routes.forEach(function (route) { return server.route(route); });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                console.log('heed');
                return [4 /*yield*/, server.inject(options)];
            case 2:
                res = _a.sent();
                response = {
                    statusCode: 200,
            ...
            case 3:
                error_1 = _a.sent();
                console.log('hello', error_1.name);
                switch (error_1.name) {
                    case 'ValidationError':
                        throw Boom.badRequest(error_1.message);
                    default:
                        throw error_1;
                }
                return [3 /*break*/, 4];
